...
class GetSportsNewsUseCase extends UseCase<List<News>,NoParameters>{
  final NewsRepository newsRepository;

  GetSportsNewsUseCase({required this.newsRepository});
  @override
  Future<Either<Failure, List<News>>> call(NoParameters parameters) async{
    return await newsRepository.getSportsNews();
  }
}