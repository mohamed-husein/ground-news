...
class GetScienceNewsUseCase extends UseCase<List<News>,NoParameters>{
  final NewsRepository newsRepository;

  GetScienceNewsUseCase({required this.newsRepository});
  @override
  Future<Either<Failure, List<News>>> call(NoParameters parameters) async{
    return await newsRepository.getScienceNews();
  }
}