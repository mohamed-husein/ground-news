...
class GetHealthNewsUseCase extends UseCase<List<News>,NoParameters>{
  final NewsRepository newsRepository;

  GetHealthNewsUseCase({required this.newsRepository});
  @override
  Future<Either<Failure, List<News>>> call(NoParameters parameters) async{
    return await newsRepository.getHealthNews();
  }
}